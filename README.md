...
```javascript
nanstdevtk = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanstdevtk@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanstdevtk@umd/bundle.js"></script>
```
